...
Fixpoint get {a: Type} (l : list (nat * a)) (target_key : nat) (default : a): a :=
  ...
  | [] =>
    ...
    default
  | (key, value) :: l' =>
    if Nat.eqb (original_sz + target_key) (new_sz + key) then
       value
...
Definition manual_gen_tree :=
    ...
    (let
       fix arb_aux (size : nat) (parent_color : Color) : G Tree :=
         ...
         | B =>
          get [
            (1, 500); (2, 500); (3, 500); (4, 500); (5, 500); (6, 500); (7, 500); (8, 500); (9, 500); (10, 500); (11, 500); (12, 500)
          ] s 0
         end in
...
Definition test_prop_DeleteDelete_size  : Checker :=  
    forAll arbitrary (fun t =>    
    forAll arbitrary (fun k =>
    forAll arbitrary (fun k' =>
      collect (append "size " (show (size t)))
        (prop_DeleteDelete t k k')))).

(* QuickChick test_prop_DeleteDelete_size. *)